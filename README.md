...
[authoring guide](docs/REFERENCE_AUTHORING.md) for buildings, façade repetitions,
roof attachments, GLB props, saved reference cameras, image overlays, and the
checked-in multi-view rooftop acceptance fixture.
