...
<level version="2" id="showcase" name="The courtyard" description="A curved courtyard, a branching partition, a ramp, stairs and an upper bridge." units="meters" wall-thickness="0.22" wall-height="3" floor-thickness="0.2" curve-tolerance="0.01">
  ...
  <material id="default" color="#e1e3df" roughness="0.85" metalness="0"/>
  <material id="concrete" color="#c6cdc8" repeat="1" roughness="0.85" metalness="0"/>
  <material id="blue" color="#72968e" repeat="1" roughness="0.65" metalness="0"/>
  <material id="sand" color="#d5aa8d" repeat="1" roughness="0.8" metalness="0"/>
  <layer id="ground" label="Ground and approaches">
    ...
    <edge id="courtyard.e0" from="courtyard.v0" to="courtyard.v1" kind="wall" control="4 -3; 10 -3"/>
    <edge id="courtyard.e2" from="courtyard.v2" to="courtyard.v3" kind="wall"/>
    <edge id="courtyard.e3" from="courtyard.v3" to="courtyard.v0" kind="wall"/>
    <edge id="partition" from="courtyard.v3" to="partition.end" kind="wall" height="1.4" material="blue"/>
    <edge id="well.e0" from="well.v0" to="well.v1" kind="railing" height="0.7"/>
    <edge id="well.e1" from="well.v1" to="well.v2" kind="railing" height="0.7"/>
    <edge id="well.e2" from="well.v2" to="well.v3" kind="railing" height="0.7"/>
    <edge id="well.e3" from="well.v3" to="well.v0" kind="railing" height="0.7"/>
    ...
    <edge id="ramp.e0" from="courtyard.v1" to="ramp.v1" kind="wall"/>
    <edge id="ramp.e1" from="ramp.v1" to="ramp.v2" kind="open"/>
    <edge id="ramp.e2" from="ramp.v2" to="east.a" kind="wall"/>
    <edge id="stairs.e0" from="east.b" to="stairs.v1" kind="wall"/>
    <edge id="stairs.e1" from="stairs.v1" to="stairs.v2" kind="open"/>
    <edge id="stairs.e2" from="stairs.v2" to="east.c" kind="wall"/>
  ...
  <layer id="upper" label="Upper bridge">
    ...
    <edge id="bridge.e0" from="bridge.v0" to="bridge.v1" kind="wall"/>
    <edge id="bridge.e1" from="bridge.v1" to="bridge.v2" kind="wall"/>
    <edge id="bridge.e2" from="bridge.v2" to="bridge.v3" kind="wall"/>
    <edge id="bridge.e3" from="bridge.v3" to="bridge.v4" kind="open"/>
    <edge id="bridge.e4" from="bridge.v4" to="bridge.v5" kind="wall"/>
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(e,t,n){return new ki({name:`SphericalGaussianBlur`,defines:{SAMPLES:Ya,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:mo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fo(){return new ki({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:mo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function po(){return new ki({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:mo(),fragmentShader:`
	...
	`}var ho=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new mi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
